...
void drawState(const std::string& state_file, const DiscreteENN_TSP& enn_tsp, const ListType& highlight_list = ListType{});
#endif
...
#if TSP_DRAW_ROOT > 0
            drawState("", *this, {id_now, static_cast<Index_t>(id_child)});
#endif
